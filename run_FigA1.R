...
legend('bottomright',lwd = 2, col = c('gray','black','black','black'),lty = c(1,5,1,3),legend = c('Exponential growth','Logistic growth','Proportional prize','Lotka-Volterra competitive'),cex = 0.7, bty = 'n')
dev.off()
